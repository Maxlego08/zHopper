...
public abstract class VInventory extends ZUtils implements Cloneable{
	...
	protected InventoryResult preOpenInventory(HopperPlugin main, Player player, int page, Object... args) throws InventoryOpenException{
	...
	public abstract InventoryResult openInventory(HopperPlugin main, Player player, int page, Object... args) throws InventoryOpenException;

	protected abstract void onClose(InventoryCloseEvent event, HopperPlugin plugin, Player player);

	protected abstract void onDrag(InventoryDragEvent event, HopperPlugin plugin, Player player);
