...
public class Config implements Saveable {
	...
	public static Button suctionButton = new Button(0, "§eSuction", 154, 0, "§eMettre une description");
	public static Button killButton = new Button(1, "§eKill", 256, 0, "§eMettre une description");
	public static Button linkButton = new Button(2, "§eLink", 54, 0, "§eMettre une description");
	public static Button blockButton = new Button(3, "§eBlock", 2, 0, "§eMettre une description");
